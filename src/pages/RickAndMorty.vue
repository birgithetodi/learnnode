...
<template>
    <div class="field has-addons">
        ...
        <div class="control">
            <button class="button is-info" @click="getPage(1)">Search</button>
        </div>
    </div>
    <nav class="pagination" role="navigation" aria-label="pagination">
        <a href="#" class="pagination-previous" :disabled="!info.prev" @click="getPage(currentPage - 1)">Previous</a>
        <a href="#" class="pagination-next" :disabled="!info.next" @click="getPage(currentPage + 1)">Next page</a>
        <ul class="pagination-list">
            ...
            <li v-for="page in generatePages(info.pages, currentPage)">
                ...
                <a v-else-if="page !== '...'" href="#" class="pagination-link" @click="getPage(page)"
                    aria-label="Goto page 1">{{ page }}
                </a>
                <span v-else class="pagination-ellipsis">&hellip;
